                        ...
                        <ul>
                            ...
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="user/shop-cart.html">Shop Cart</a></li>
                                    <li><a href="user/checkout.html">Checkout</a></li>
                                    <li><a href="user/blog-details.html">Blog Details</a></li>
                                </ul>
                            </li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    data-setbg="user/img/categories/category-1.jpg">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="user/img/categories/category-2.jpg">
                            <div class="categories__text">
                                <h4>Men’s fashion</h4>
                                <p>358 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="user/img/categories/category-3.jpg">
                            <div class="categories__text">
                                <h4>Kid’s fashion</h4>
                                <p>273 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="user/img/categories/category-4.jpg">
                            <div class="categories__text">
                                <h4>Cosmetics</h4>
                                <p>159 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="user/img/categories/category-5.jpg">
                            <div class="categories__text">
                                <h4>Accessories</h4>
                                <p>792 items</p>
                                <a href="#">Shop now</a>
                ...
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="user/img/product/product-1.jpg">
                        ...
                        <ul class="product__hover">
                            <li><a href="user/img/product/product-1.jpg" class="image-popup"><span class="arrow_expand"></span></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix men">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="user/img/product/product-2.jpg">
                        <ul class="product__hover">
                            <li><a href="user/img/product/product-2.jpg" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix accessories">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="user/img/product/product-3.jpg">
                        ...
                        <ul class="product__hover">
                            <li><a href="user/img/product/product-3.jpg" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix cosmetic">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="user/img/product/product-4.jpg">
                        <ul class="product__hover">
                            <li><a href="user/img/product/product-4.jpg" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix kid">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="user/img/product/product-5.jpg">
                        <ul class="product__hover">
                            <li><a href="user/img/product/product-5.jpg" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    <div class="product__item__pic set-bg" data-setbg="user/img/product/product-6.jpg">
                        ...
                        <ul class="product__hover">
                            <li><a href="user/img/product/product-6.jpg" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="user/img/product/product-7.jpg">
                        <ul class="product__hover">
                            <li><a href="user/img/product/product-7.jpg" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    <div class="product__item__pic set-bg" data-setbg="user/img/product/product-8.jpg">
                        ...
                        <ul class="product__hover">
                            <li><a href="user/img/product/product-8.jpg" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
...
<section class="banner set-bg" data-setbg="user/img/banner/banner-1.jpg">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
                ...
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="user/img/trend/ht-1.jpg" alt="">
                        </div>
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="user/img/trend/ht-2.jpg" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="user/img/trend/ht-3.jpg" alt="">
                        </div>
                        <div class="trend__item__text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="user/img/trend/bs-1.jpg" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Cotton T-Shirt</h6>
                            <div class="rating">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="user/img/trend/bs-2.jpg" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="user/img/trend/bs-3.jpg" alt="">
                        </div>
                        <div class="trend__item__text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="user/img/trend/f-1.jpg" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="user/img/trend/f-2.jpg" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="user/img/trend/f-3.jpg" alt="">
                        </div>
                        <div class="trend__item__text">
        ...
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="discount__pic">
                    <img src="user/img/discount.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-6 p-0">
