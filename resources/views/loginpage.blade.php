...
<body>
  <div class="hidden modal fade" id="modalregis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('doLogin') }}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="text" placeholder="Masukkan email" class="form-control" name="email" tabindex="1" required autofocus>
